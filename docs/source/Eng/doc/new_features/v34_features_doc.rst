...
connect to it: percent-decoded, IDNA-encoded (a soft hyphen, fullwidth characters
or an ideographic full stop fold away; patterns are encoded the same way), without
a trailing dot, and with an IP literal
