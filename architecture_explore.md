...
#### `utils/mcp_server/`（17,611 行，676 個工具）— 最大子系統
...
| --- | ---: | ---: |
| `gui/` | 91 | 26,794 |
| `utils/mcp_server/` | 31 | 17,611 |
| `utils/remote_desktop/` | 56 | 12,442 |
| `utils/executor/` | 7 | 9,294 |
| `utils/usb/` | 17 | 4,422 |
...
| `utils/hotkey/` | 7 | 783 |
| 其餘模組（約 286 個 `utils/` 子套件 + `android/`／`ios/`／周邊小工具） | 676 | 50,161 |
| **總計** | **1,042** | **145,361** |
