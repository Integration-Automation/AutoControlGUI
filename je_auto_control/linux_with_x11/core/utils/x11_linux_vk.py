...
x11_linux_key_slash_b = display.keysym_to_keycode(XK.string_to_keysym("backslash"))
...
x11_linux_key_newline_t = display.keysym_to_keycode(XK.string_to_keysym("Tab"))
