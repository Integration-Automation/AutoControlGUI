...
english_word_dict = {
    ...
    "tab_assertions": "Assertions",
    "tab_data_source": "Data Sources",
    "tab_flakiness": "Flaky Tests",
    "tab_test_suite": "Test Suites",

    # Test Suites tab
    "suite_spec_label": "Suite spec (JSON)",
    "suite_load_file": "Load file…",
    "suite_run": "Run suite",
    "suite_junit": "Write JUnit XML…",
    "suite_allure": "Write Allure dir…",
    "suite_col_case": "Case",
    "suite_col_status": "Status",
    "suite_col_time": "Time",
    "suite_col_message": "Message",
    "suite_summary": "{passed} passed, {failed} failed, {errored} errored, {skipped} skipped",
    "suite_error": "Run failed: {error}",
    "suite_q_label": "Quarantine",
    "suite_q_auto": "Auto-quarantine flaky",
    "suite_q_clear": "Clear quarantine",
    "suite_q_remove": "Release selected",
    "tab_a11y_audit": "A11y Audit",
    "tab_device_matrix": "Device Matrix",
    "tab_media_checks": "Media Checks",

    # Accessibility audit tab
    "audit_app": "App name (blank = all)",
    "audit_run": "Run audit",
    "audit_col_kind": "Kind",
    "audit_col_severity": "Severity",
    "audit_col_target": "Target",
    "audit_col_message": "Message",
    "audit_summary": "{errors} errors, {warnings} warnings",
    "audit_contrast_label": "Contrast check (fg / bg RGB)",
    "audit_contrast_run": "Check contrast",

    # Device matrix tab
    "dm_devices": "Devices (JSON list)",
    ...
    "media_audio_duration": "Duration (s)",
    "media_audio_threshold": "RMS threshold",
    "media_audio_expect": "Expect sound",
    "media_audio_run": "Record & check audio",
    "media_video_label": "Video motion check",
    "media_video_path": "Video file",
    "media_video_browse": "Browse…",
    "media_video_threshold": "Motion threshold",
    "media_video_expect": "Expect motion",
    "media_video_run": "Check video",
    "media_result": "Result",

    # Assertions tab
    "assert_kind": "Assertion",
    "assert_kind_text": "Text on screen (OCR)",
    ...
    "assert_target_window_hint": "Window title contains",
    "assert_pixel_xy": "x, y",
    "assert_pixel_rgb": "r, g, b",
    "assert_expect_present": "Expect present / match / exists",
    "assert_regex": "Treat text as regex",
    "assert_run": "Run assertion",
    "assert_passed": "PASS",
    "assert_failed": "FAIL",
    ...
    "ds_path": "File path",
    "ds_browse": "Browse…",
    "ds_query": "SQL query (SELECT only)",
    "ds_inline": "Inline JSON rows",
    "ds_limit": "Row limit (0 = all)",
    "ds_load": "Load rows",
    "ds_row_count": "{n} rows loaded",
    "ds_error": "Load failed: {error}",

    # Flaky Tests tab
    "flaky_refresh": "Refresh",
    "flaky_limit": "Runs to scan",
    "flaky_min_runs": "Min runs",
    "flaky_group_by": "Group by",
    "flaky_col_key": "Script / Source",
    "flaky_col_runs": "Runs",
    "flaky_col_ok": "Pass",
    "flaky_col_error": "Fail",
    "flaky_col_flips": "Flips",
    "flaky_col_flip_rate": "Flip rate",
    "flaky_col_pass_rate": "Pass rate",
    "flaky_col_last": "Last",
    "flaky_col_flaky": "Flaky?",
    "flaky_summary": "{flaky} flaky of {total} groups",
    ...
    "usb_browser_open_loopback": "Opened {vid}:{pid} locally — descriptor {hex}",
    ...
    "usb_share_disable": "Disable sharing",
    "usb_share_sharing_on": "Sharing on",
    "usb_share_sharing_off": "Not sharing",
    "usb_share_acl_tampered": "ACL signature mismatch — fail closed",
    "usb_share_local_devices": "Local USB devices",
    "usb_share_refresh_local": "Refresh",
    "usb_share_allow": "Allow",
    "usb_share_block": "Block",
    "usb_share_allowed": "Allowed {vid}:{pid}",
    "usb_share_blocked": "Blocked {vid}:{pid}",
    "usb_share_select_first": "Select a device row first.",
    "usb_share_col_vid": "VID",
    "usb_share_col_pid": "PID",
    "usb_share_col_product": "Product",
    "usb_share_col_serial": "Serial",
    "usb_share_col_policy": "Policy",
    ...
    "usb_share_opening": "Opening {vid}:{pid}…",
    "usb_share_opened": "Opened {vid}:{pid} — descriptor {hex}",
    "usb_share_open_failed": "Failed: {error}",
    "usb_share_listing": "Listing…",
    "usb_share_listed": "{count} shared device(s).",
    "usb_share_remote_group": "Browse a remote host (REST)",
    ...
    "tr_combine_all": "Combine → All",
    "tr_combine_any": "Combine → Any",
    "tr_combine_seq": "Combine → Sequence",
    "tr_combine_need_two": "Select at least two triggers to combine.",
    ...
    "rd_quick_viewer_token": _TOKEN_LABEL,
