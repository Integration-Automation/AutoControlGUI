...
japanese_word_dict = {
    ...
    "tab_vlm": "AI ロケーター",
    "tab_self_healing": "セルフヒーリング",
    "tab_webrunner": "WebRunner ブラウザ",
    "tab_computer_use": "Computer Use エージェント",
    "tab_dag_runner": "DAG ランナー",
    "tab_presence": "ビューア名簿",
    "tab_chatops": "Chat-Ops",
    "tab_flow_editor": "フローエディタ",
    "tab_trace_replay": "トレース再生",
    ...
    "usb_browser_open_loopback": "{vid}:{pid} をローカルで開きました — ディスクリプタ {hex}",
    ...
    "usb_share_disable": "共有を無効化",
    "usb_share_sharing_on": "共有中",
    "usb_share_sharing_off": "未共有",
    "usb_share_acl_tampered": "ACL 署名が不一致 — fail-closed",
    "usb_share_local_devices": "ローカル USB デバイス",
    "usb_share_refresh_local": "更新",
    "usb_share_allow": "許可",
    "usb_share_block": "ブロック",
    "usb_share_allowed": "{vid}:{pid} を許可しました",
    "usb_share_blocked": "{vid}:{pid} をブロックしました",
    "usb_share_select_first": "先にデバイス行を選択してください。",
    "usb_share_col_vid": "VID",
    "usb_share_col_pid": "PID",
    "usb_share_col_product": "製品",
    "usb_share_col_serial": "シリアル",
    "usb_share_col_policy": "ポリシー",
    ...
    "usb_share_opening": "{vid}:{pid} を開いています…",
    "usb_share_opened": "{vid}:{pid} を開きました — ディスクリプタ {hex}",
    "usb_share_open_failed": "失敗：{error}",
    "usb_share_listing": "一覧中…",
    "usb_share_listed": "共有デバイス {count} 件。",
    "usb_share_remote_group": "遠隔ホストを閲覧（REST）",
    ...
    "tr_combine_all": "すべて結合",
    "tr_combine_any": "いずれか結合",
    "tr_combine_seq": "順次結合",
    "tr_combine_need_two": "結合するトリガーを2つ以上選択してください。",
    ...
    "self_heal_form_title": "セルフヒーリングの実行",
    "self_heal_template_label": "テンプレート画像:",
    "self_heal_template_placeholder": "PNG / JPG パス（任意）",
    "self_heal_desc_label": "説明:",
    ...
    "self_heal_inputs_required": "テンプレートまたは説明を入力してください",
    "self_heal_hit": "ヒット ({x}, {y})",
    "self_heal_miss": "ミス — 画像と VLM の両方が失敗",
    "self_heal_error": "エラー",
    "self_heal_col_timestamp": "時刻",
    ...
    "web_unavailable": "WebRunner が未インストール（pip install je_web_runner）",
    "web_convenience_title": "ブラウザのクイック操作",
    "web_freeform_title": "任意の WR_* コマンドを実行",
    "web_url_label": "URL:",
    ...
    "web_action_label": "コマンド:",
    "web_action_placeholder": "WR_to_url、WR_left_click など",
    "web_params_label": "パラメータ (JSON):",
    "web_params_placeholder": "{\"url\": \"https://example.com\"}",
    "web_run_btn": "実行",
    "web_refresh_btn": "コマンド一覧",
    "web_commands_label": "WR_* コマンド:",
    "web_output_label": "出力:",
    "web_url_required": "URL を入力してください",
    "web_screenshot_required": "スクリーンショットのパスを入力してください",
    "web_action_required": "コマンド名を入力してください",
    "web_error": "エラー",

    # Computer-Use Tab
    "computer_use_goal_label": "目標:",
    "computer_use_goal_placeholder": "例: Slack を開いて #general に「おはよう」と投稿する",
    "computer_use_model_label": "モデル:",
    "computer_use_max_steps_label": "最大ステップ数:",
    "computer_use_wall_seconds_label": "実時間上限 (秒):",
    ...
    "computer_use_error": "エラー",
    "computer_use_goal_required": "まず目標を入力してください。",
    ...
    "dag_success": "すべてのノードが成功 ({seconds}秒)。",
    "dag_failure": "失敗/スキップしたノードがあります ({seconds}秒)。",
    "dag_valid": "検証成功: {count} ノード。",
    "dag_invalid": "DAG が無効",
    "dag_empty": "DAG エディタが空です。",
    "dag_error": "エラー",
    "dag_col_id": "ID",
    "dag_col_host": "ホスト",
    "dag_col_status": "ステータス",
    "dag_col_duration_ms": "ミリ秒",
    "dag_col_error": "エラー",

    # Presence Roster Tab
    "presence_refresh_btn": "更新",
    "presence_promote_btn": "コントローラに昇格",
    "presence_demote_btn": "観察者に降格",
    "presence_kick_btn": "ビューアを切断",
    "presence_count": "接続中のビューア: {count}",
    "presence_no_selection": "ビューアを先に選択してください",
    "presence_error": "エラー",
    "presence_col_viewer_id": "Viewer ID",
    "presence_col_label": "ラベル",
    "presence_col_role": "ロール",
    ...
    # Flow Editor Tab
    "flow_open_btn": "JSON を開く...",
    "flow_save_btn": "JSON を保存...",
    "flow_zoom_in_btn": "拡大",
    "flow_zoom_out_btn": "縮小",
    "flow_fit_btn": "全体表示",
    "flow_inspector_placeholder": "ノードをクリックしてパラメータを表示。",
    "flow_loaded": "{count} 個のノードを読み込み。",
    "flow_saved": "{path} に保存しました。",
    "flow_empty": "保存するものがありません — 先にスクリプトを開いてください。",

    # Trace Replay Tab
    "trace_open_btn": "録画を開く...",
    "trace_first_btn": "先頭へ",
    "trace_prev_btn": "前のフレーム",
    "trace_next_btn": "次のフレーム",
    "trace_last_btn": "末尾へ",
